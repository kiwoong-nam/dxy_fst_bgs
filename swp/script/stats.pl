...
my $popD='/home/knam/work/sfrugi_Repro/simulation/swp/stats/pop';
my $statD='/home/knam/work/sfrugi_Repro/simulation/swp/stats';
...
`vcftools --gzvcf $input --weir-fst-pop $popD/p1 --weir-fst-pop $popD/p2 --fst-window-size 20000 --fst-window-step 20000 --out $statD/$cate.$id.$time`;

`vcftools --gzvcf $input --keep $popD/p1 --window-pi 20000 --out $statD/$cate.$id.$time`;

`python3 /home/knam/save/programs/Dxy-master/Dxy_calculate -v $input -p $popD/pops -w 20000 -s 20000 -o $statD/$cate.$id.$time.dxy`;
